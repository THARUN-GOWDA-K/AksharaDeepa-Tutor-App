<div align="center">
  <img src="app/src/main/res/mipmap-xxxhdpi/ic_launcher.png" width="140" height="140" alt="Akshara Deepa Tutor logo" />
...
<div align="center">
  <table border="0">
    <tr>
      <td align="center">
        <img src="app/src/main/res/mipmap-xxxhdpi/ic_launcher.png" width="120" height="120" alt="App icon" />
        <br /><b>App Icon</b>
      </td>
      <td align="center">
        <img src="app/src/main/res/mipmap-xxxhdpi/ic_launcher_round.png" width="120" height="120" alt="Round icon" />
        <br /><b>Round Icon</b>
      </td>
    </tr>
  </table>
...
- Use `app/google-services.example.json` as a template.
...
If you prefer a file-based credential, use `backend/app/firebase-credentials.example.json` as a starting point.
...
## Repo Root Utilities
The repo root includes optional generators and data scripts:
